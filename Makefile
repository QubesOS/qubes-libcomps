...
FEDORA_SOURCES := https://src.fedoraproject.org/rpms/libcomps/raw/f$(subst fc,,$(DIST))/f/sources
SRC_FILE := libcomps-$(VERSION).tar.gz

BUILDER_DIR ?= ../..
SRC_DIR ?= qubes-src

DISTFILES_MIRROR ?= https://github.com/rpm-software-management/libcomps/archive/libcomps-$(VERSION)/
